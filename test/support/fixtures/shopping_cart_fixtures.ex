defmodule LearnPhoenix.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `LearnPhoenix.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> LearnPhoenix.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> LearnPhoenix.ShoppingCart.create_cart_item()
